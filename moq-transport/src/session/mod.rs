...
impl Session {
    ...
    pub async fn connect_role(
        ...
        let versions: setup::Versions = [setup::Version::DRAFT_09].into();
    ...
    pub async fn accept_role(
        ...
        if !client.versions.contains(&setup::Version::DRAFT_09) {
            return Err(SessionError::Version(
                client.versions,
                [setup::Version::DRAFT_09].into(),
            ));
        }
        ...
        let server = setup::Server {
            role,
            version: setup::Version::DRAFT_09,
            params: Default::default(),
        };
